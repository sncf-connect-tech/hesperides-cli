...
from hesperidescli.templates.templates import (
...
class TestTemplates(unittest.TestCase):
    def test_create_template_package_missing_from_package_name_when_from_package_version_is_given(
        ...
        result = runner.invoke(
            create_template_package, ["--from_package_version", "1.0.0"]
        )
        assert (
            result.output
    ...
    def test_create_template_package_workingcopy_missing_package_version(self):
        runner = CliRunner()
        result = runner.invoke(
            create_template_package_workingcopy, ["--package_name", "toto"]
        )
    ...
    def test_delete_template_package_release_missing_package_version(self):
        runner = CliRunner()
        result = runner.invoke(
            delete_template_package_release, ["--package_name", "toto"]
        )
        assert result.output == "--package_version required\nAborted!\n"
    ...
    def test_delete_template_package_workingcopy_missing_package_version(self):
        runner = CliRunner()
        result = runner.invoke(
            delete_template_package_workingcopy, ["--package_name", "toto"]
        )
        assert result.output == "--package_version required\nAborted!\n"
    ...
    def test_get_template_package_release_model_missing_package_version(self):
        runner = CliRunner()
        result = runner.invoke(
            get_template_package_release_model, ["--package_name", "toto"]
        )
        assert result.output == "--package_version required\nAborted!\n"
    ...
    def test_get_template_package_workingcopy_missing_package_version(self):
        runner = CliRunner()
        result = runner.invoke(
            get_template_package_workingcopy, ["--package_name", "toto"]
        )
        assert result.output == "--package_version required\nAborted!\n"
    ...
    def test_get_template_package_workingcopy_model_missing_package_version(self):
        runner = CliRunner()
        result = runner.invoke(
            get_template_package_workingcopy_model, ["--package_name", "toto"]
        )
        assert result.output == "--package_version required\nAborted!\n"
    ...
    def test_get_templates_packages_release_missing_package_version(self):
        runner = CliRunner()
        result = runner.invoke(
            get_templates_packages_release, ["--package_name", "toto"]
        )
        assert result.output == "--package_version required\nAborted!\n"
    ...
    def test_get_templates_packages_workingcopy_missing_package_version(self):
        runner = CliRunner()
        result = runner.invoke(
            get_templates_packages_workingcopy, ["--package_name", "toto"]
        )
        assert result.output == "--package_version required\nAborted!\n"
    ...
    def test_update_template_package_workingcopy_missing_package_version(self):
        runner = CliRunner()
        result = runner.invoke(
            update_template_package_workingcopy, ["--package_name", "toto"]
        )
        assert result.output == "--package_version required\nAborted!\n"
