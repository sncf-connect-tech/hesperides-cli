...
@click.command("delete-application-cache", deprecated=True, hidden=True)
...
@click.command("delete-applications-cache", deprecated=True, hidden=True)
def delete_applications_cache():
    return


@click.command("delete-modules-cache", deprecated=True, hidden=True)
def delete_modules_cache():
    return


@click.command("delete-release-modules-cache", deprecated=True, hidden=True)
...
@click.command("delete-template-package-cache", deprecated=True, hidden=True)
...
@click.command("delete-workingcopy-modules-cache", deprecated=True, hidden=True)
@click.option("--module-name")
@click.option("--module-version")
...
@click.command("delete-workingcopy-template-package-cache", deprecated=True, hidden=True)
@click.option("--template-name")
@click.option("--template-version")
...
@click.command("regenerate-application-cache", deprecated=True, hidden=True)
@click.option("--application-name")
@click.option("--platform-name")
...
@click.command("regenerate-module-cache", deprecated=True, hidden=True)
@click.option("--module-name")
@click.option("--module-version")
...
@click.command("regenerate-template-package-cache", deprecated=True, hidden=True)
@click.option("--template-name")
@click.option("--template-version")
